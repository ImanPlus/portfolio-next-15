        ...
        <div>
          ...
          <div className="mt-7">
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <p className="text-xl font-bold text-gray-400">Mashhad, Iran</p>
            </div>
            {/* social icons */}
            <div className="flex item-center mt-8 space-x-3">
              <div className="w-14 h-14 bg-blue-950/60 rounded-full flex items-center cursor-pointer justify-center flex-col hover:bg-blue-600 transition-all duration-300 ">
